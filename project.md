...
10. ☐ **Clickable ingredient/product chips in recipe card (AgGrid)** — ⚡ ingredient and product chips in the recipe card should link to that item's own recipe; query param onclick approach with handler at top of Items tab
